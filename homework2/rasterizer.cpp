...
{   
    ...
    Eigen::Vector3f ab = *b - *a; ab[2] = 0;
    Eigen::Vector3f ap = p - *a; ap[2] = 0;

    Eigen::Vector3f bc = *c - *b; bc[2] = 0;
    Eigen::Vector3f bp = p - *b; bp[2] = 0;

    Eigen::Vector3f ca = *a - *c; ca[2] = 0;
    Eigen::Vector3f cp = p - *c; cp[2] = 0;
